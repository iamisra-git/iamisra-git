...
I’m currently working as a **Full-Stack Software Engineer at SLB (Schlumberger), UK**, where I build backend features in Go, work with JSON Schemas for structured data, and develop UI components in Angular for engineering software used in the energy industry.
...
**Backend:** Go · Node.js · Express · REST APIs · JSON Schema · MongoDB  
**Tools:** Firebase · JMeter · Postman · Docker · Git · Azure DevOps  
**Concepts:** Full-stack development · Cloud systems · API design · Data modeling · UI/UX · 3D logic · Performance testing  
...
• Full CRUD operations (posts, bookings, dashboard)  
• Firebase authentication (prototype) → MongoDB auth (final version)  
• Load & stress testing with JMeter and API testing with Postman  
**Tech:** MongoDB · Express · React · Node.js · Firebase  

---

### Offshore Riser Simulation – Go + JSON Schema + Angular _(SLB work project)_  
Worked on a cloud-based engineering tool to model lazy-wave and catenary risers in 3D.  
• Built backend logic in Go for curve fitting and pipeline calculations  
• Designed and validated JSON Schemas for data exchange between backend and UI  
• Helped upgrade and fix UI components during Angular migration  
**Tech:** Go · JSON Schema · Angular · Numerical modeling · Cloud APIs  

_(Code not public, part of work repo)_
...
**Freelance Programming Tutor — SuperProf**  
Taught C#, PHP, OOP, and full-stack fundamentals to students (including neurodiverse learners)
